...
export class Tab2Page {
  ...
  ngOnInit() {
        ...
        this.dataService.leerDatos('/seguridad_2/estado').subscribe((data1) => {
          this.data1 = data1;
          this.toggleValue = this.data1; 
          console.log(this.data)// Actualiza el valor del toggle
          });
      //     this.dataService.leertemp('/seguridad_2').subscribe((data2) => {
      //       this.data2 = data2;
      ...
      //     let ruta: string = '/seguridad_2/dia';
      //     let datos: any;
  ...
  if (this.toggleValue== true) {
    const alert = await this.alertController.create({
      header: 'Precaución',
      subHeader: 'Has apagado el sensor',
